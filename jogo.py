...
class Personagem:
    ...
    def __init__(self, name, life, mana, hab1, hab2, hab3,  pos_y, pos_x, cor):
        self.name = name
        self.life = life
        self.max_hp = life
        self.mana = mana
...
class Fight:
    ...
    def enter(self, p:Personagem):
        ...
        if y == 1: # set do inimigo "cobrinha"
            inimigo = Inimigo("Cobrinha", 10,"                                                 \n                       .....-==:.     .          \n                      .-+***#%##**++++:          \n                   .-=*#**%%##*#*+*+##*:         \n                  .**#**#%%#%%##**++++*#####*+:  \n                  ###******#*+*#*+=***++###*-.   \n         .-=-.    .==: .-+####%%%###+++++##*:    \n        ..      .  :-:  .=##%%%#=%%%#***+*###+:  \n        :               .+%%=.    *%##*+=**#=    \n         :.           .=#*=.       +%##*++*%#.   \n          .::      .:+=.    .::..  -%#*****#%=   \n             .:---:..  :*########+:*##*+**#%%:   \n                   .:=###***#***##%%#*++*##%*    \n                 :=*%%#**#%#*+*#%%#*****##%%-    \n                  -####*#%#*******+*++**##%+.    \n     .:.        -#######%%##***+**+****###=      \n  .-+.          :###*#%%%%%###*******###%=.      \n .=+.          .+#####%%%%%%#########%#=:        \n.=*:           .*%####%%@%.+%%%%%%%%*.           \n.**.           :#%##%%%%%-    .--:.              \n.*#:           .*%%%%%%%%%-:-==--::.             \n.##+           .*%#*****++*++****###**=.         \n =###.       .+##*+**+**+++***#*#***###%#:       \n .=###+-.  .*%####*##**#*###########%%%%%*.      \n   :*%###%%%%%#########%%%%%%%%%%%%%%%%%%*.      \n     .+%%%%%%#%%%%%%%%%%%%@@@@@%%%%@@@@@%+       \n        .:#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%=.       \n           :#%@@%%%%%%%##*#**##****#****###+-    \n             .*%%%%%%%#####*###***##*###%##%%*.  \n           :. #%%%%%%%%%%%#%%%####%##%%%%#%%%#:  \n            =.+%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#:  \n          .--#+*%%%%%%%%%%%%%%%%%%%%%%%%%%%%#::  \n            .:..  ..:-*#%%%%%#*=---:.=*++#%*-    \n                                 .-=-:.....      \n" )
        elif y == 2: # set do inimigo "ogro"
            inimigo = Inimigo("Ogro", 30,"                                          \n                                                 \n   .--::.   +=+=#==##%#+**+#++*-..               \n  -*+**##   .##*#%%#*##%%+++*#**%@*              \n  +#****#  .==#%%@@%##@%#+*%#++++*@%.            \n :+*#***#: =%%+***#%@%%%#*#*=++****+++           \n  -%%#####+-*#%#%+**#%%%*%@%**##*+**##*:         \n   :@%%%@@:  %%+++*%%@@#@%##@@%**+*##+*%#        \n    =%%%@:   .%@%%@@@@@#++**%@@@%%%@#*#@@:       \n     :##%*    -**%%%%@@%#%%%%%@@@@@@#%@@@:       \n      +%#@-..==*#%@@@@@@@@@@@@@@@@@+:*#%.        \n     :***+**-:=***%@%*+**=**%%%%@@@*#%%:         \n     .+#@@@@###%@@@@%%#**#@@%#%@#+++*#@:         \n      :*%@@*=-+%%%@#**####=+%%%@%*##*%@=         \n        -#=    .++*%%##+=+#%@%*#%@@@@@%%         \n              -*++++*%@%##@%*+*++#@@%=-.         \n             =**#***%@@@@#@@#*+*#%@@%.           \n             =%%@%%@@@@*  .:#@**#@@%@*.          \n            .%*+##**%@@+    -##@@#++@@*.         \n              --:*@@%###:    -+#*%@@@%@%.        \n                 -*%####%:       .#@@@@%+        \n              .=#****#@%@#*******##**#*%@=       \n             =#############@@@@@%%%%%%%%@#.      \n")
...
def mover(dire, p:Personagem, matriz):
...
def map_print(mapa, p:Personagem):
    aux = 0
...
def desenhar_menu(tipo, mapa, p:Personagem):
    cabecalho(tipo)
...
def info_print(linha, p:Personagem):
    match linha:
        case 0:
            print("\t<<CHAR INFO>>\t", end="")
        case 1:
            pinta(" - HERO: {}".format(p.name), p.cor, 0)
        case 2:
            display_barra("HP", p.life, p.max_hp)
        case 3:
            display_barra("MP", p.mana, p.max_mp)
...
def verifica_pos(p:Personagem, per:SelecaoPersonagem):
...
match per.classe:
            case 1:  # set do personagem mago
                p = Personagem("Magnus, a Bruxa", 13, 20, "Bola de fogo", "Espinho de gelo", "Míssel Arcano", 1,1, 6)
            case 2:  # set do personagem guerreiro
                p = Personagem("Absalom, o Cavalheiro", 20, 10, "Golpe giratório", "Golpe perfurante", "Rasga bucho",1,1,1)
            case 3:  # set do personagem Ladino
                p = Personagem("Freire, a Ladra", 15, 12, "Ataque das sombras", "Golpe fantasma", "Lâmina das trevas",1,1,2)
